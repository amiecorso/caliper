...
parser.add_argument("--tperb", default=20)
...
SAVE_AS = time.strftime("%m-%d-%y") + "mauna_TPB{}".format(TPERB)
INTERVALS = [20]
NET_SIZES = [1, 2, 4, 6, 8]
REPEATS = 1
TIME = 2000
#           (TPS, duration, unfinished)
WORKLOADS = [(5, 800, 200), (10, 800, 200), (15, 800, 200), (20, 800, 200), (30, 800, 200), (40, 800, 200), (50, 800, 200)]
...
for n in NET_SIZES:
    for interval in INTERVALS:
        ...
        for load in WORKLOADS:
            ...
            command = "python ./generators/benchconfig_file_gen.py --exp_dir {} --template {} --tps {} --duration {} --unfinished {} --txnsperbatch {} --label {}".format(THIS_DIR, BENCHCONFIG_TEMPLATE, tps, duration, unfinished, TPERB, str(tps) + "TPS" + str(interval) + "sec")
            subprocess.call(command, shell=True)
...
command = "ssh amie@{} \"python {}/data_scripts/process_exp.py --exp_dir {} --tperb {}\"".format(REMOTEIP, EXP_DIR, EXP_DIR, TPERB)
subprocess.call(command, shell=True)
