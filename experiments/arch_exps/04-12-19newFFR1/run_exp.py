...
# auto-generate this?
SAVE_AS = time.strftime("%m-%d-%y") + "newFFR"
NET_SIZES = [1]
REPEATS = 1
#           (TPS, duration, unfinished)
#WORKLOADS = [(5, 1000, 5), (10, 1000, 5), (15, 1000, 5), (20, 1000, 5), (25, 1000, 5), (30, 1000, 5), (35, 1000, 5), (40, 1000, 5)]
WORKLOADS = [(5, 60, 5)]
TIME = 6000000 # maximum time to run external monitor... should at least be as long as the duration of experiment, otherwise monitor will come down early
#LEAVE_UP = True
LEAVE_UP = False
