...
for n in NET_SIZES:
    for load in WORKLOADS:
        ...
        command = "python ./generators/benchconfig_file_gen.py --exp_dir {} --template {} --tps {} --duration {} --unfinished {} --txnsperbatch {} --label {}".format(EXP_DIR, BENCHCONFIG_TEMPLATE, 5, 10, 5, 20, "5TPS")
        subprocess.call(command, shell=True)
