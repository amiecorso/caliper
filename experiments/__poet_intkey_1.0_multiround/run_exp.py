...
WORKLOADS = [(5, 500, 5), (15, 500, 5), (25, 500, 5), (40, 500, 5)]
#WORKLOADS = [(5, 10, 5), (20, 10, 5)]
...
for n in NET_SIZES:
    for load in WORKLOADS:
        ...
        command = "python ~/caliper/experiments/benchconfig_file_gen.py --exp_dir {} --template {} --tps {} --duration {} --unfinished {} --txnsperbatch {} --label {} --rounds {}".format(EXP_DIR, BENCHCONFIG_TEMPLATE, tps, duration, unfinished, 20, str(tps) + "TPS", ROUNDS)
        subprocess.call(command, shell=True)
