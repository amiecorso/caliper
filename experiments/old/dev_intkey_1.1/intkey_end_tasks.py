...
compose_file = "dev-intkey-1.1-official.yaml"
exp_dir = "~/caliper/experiments/dev_intkey_1.1/"

parse_logs = "python3 ~/caliper/experiments/stale_blocks/parse_logs.py --n 1 --dest {}results/ --rest_url http://sawtooth-rest-api-default:8008 --single && sleep 10".format(exp_dir)
